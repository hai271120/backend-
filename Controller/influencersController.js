...
const influencerCtrl = {
    ...
    createInfluencer: async(req, res) =>{
        try {
            const {influencer_id, facebook,address,name,images,instagram,tiktok,category,followface,followinstagram} = req.body;
            ...
            const newInfluencer = new Influencer({
                influencer_id, name: name.toLowerCase(), tiktok, instagram,facebook, images,address,category,followface,followinstagram
            })
    ...
    updateInfluencer: async(req, res) =>{
        try {
            ...
            await Influencer.findOneAndUpdate({_id: req.params.id}, {
                name: name.toLowerCase(),  tiktok, instagram,facebook, images,address,category,followface,followinstagram
            })
